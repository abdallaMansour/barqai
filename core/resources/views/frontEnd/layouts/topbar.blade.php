            ...
            @if (Helper::GeneralWebmasterSettings('dashboard_link_status'))
                @if (Auth::check())
                    <div class="dropdown header-dropdown d-none d-sm-block">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownDashboardBtn">
                            <li>
                                <a class="dropdown-item" href="https://app.barqai.io" target="_blank"><i class="fa fa-cog"></i> {{ __('frontend.dashboard') }}</a>
                            </li>
                ...
                @else
                    <span class="d-none d-sm-block dashboard_Link">
                        ...
                        <a href="https://app.barqai.io" target="_blank"><i class="fa fa-cog"></i> {{ __('frontend.dashboard') }}</a>
                    </span>
                @endif
            @endif
